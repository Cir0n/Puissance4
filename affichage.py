...
def affiche_menu(window):
    ...
    local_button = Button(window, text="Jouer en local", command=lambda: affiche_partie_locale(window), font=font_style,
                          width=20, pady=20, bd=0, highlightthickness=0)
    local_button.grid(row=2, column=2, columnspan=1, sticky=EW, pady=15)

    online_button = Button(window, text="Jouer en ligne", command=lambda: affiche_partie_en_ligne(window),
    ...
    rule_button = Button(window, text="Voir les règles", command=lambda: affiche_partie_locale(window), font=font_style,
                         width=20, pady=20, bd=0, highlightthickness=0)
...
def affiche_partie_locale(window):
    clear(window)
    # Création du titre
    ...
    partie_joueurs_button = Button(window, text="Jouer à 2", command=lambda: jeu_local(window), font=font_style,
                                   width=20, pady=20,
                                   bd=0, highlightthickness=0)
    partie_joueurs_button.grid(row=2, column=2, columnspan=1, sticky=EW, pady=15)

    ordi_button = Button(window, text="Jouer contre l'ordinateur", command=lambda: affiche_partie_ordi(window),
                         font=font_style, width=20, pady=20, bd=0, highlightthickness=0)
    ordi_button.grid(row=3, column=2, columnspan=1, sticky=EW, pady=15)

    quit_button = Button(window, text="Retour au menu", command=lambda: affiche_menu(window), pady=20, fg='black', bd=0,
                         highlightthickness=0, font=font_style)
...
def affiche_partie_ordi(window):
    clear(window)
...
def affiche_partie_en_ligne(window):
    clear(window)
    # Création du titre
    ...
    creer_partie_button = Button(window, text="Créer une partie", command=lambda: affiche_creer_en_ligne(window),
                                 font=font_style, width=20, pady=20, bd=0, highlightthickness=0)
    ...
    rejoindre_button = Button(window, text="Rejoindre une partie",
                              command=lambda: affiche_rejoindre_partie_en_ligne(window), font=font_style, width=20,
...
def affiche_creer_en_ligne(window):
    clear(window)
